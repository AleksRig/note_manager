...
def save_notes_to_file(notes, filename):
    ...
    try:
        with open(filename.yaml, 'w', encoding='utf-8') as file:  # Указываем кодировку utf-8
            yaml.dump(notes, file, default_flow_style=False, allow_unicode=True)  # Включаем поддержку Unicode
